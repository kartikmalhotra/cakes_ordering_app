...
class LocalStorageService {
  ...
  /// Check Subscription Purchased
  bool? get checkSubscriptionPurchased =>
      _getDataFromDisk(
          AppLocalStoragePreferencesKeys.checkSubscriptionPurchased) ??
      true;
  set checkSubscriptionPurchased(bool? value) => _saveDataToDisk(
      AppLocalStoragePreferencesKeys.checkSubscriptionPurchased, value);
  ...
  /// Check Post Muted
  bool? get checkPostMuted =>
      _getDataFromDisk(AppLocalStoragePreferencesKeys.postMuted) ?? true;
  set checkPostMuted(bool? value) =>
      _saveDataToDisk(AppLocalStoragePreferencesKeys.postMuted, value);
  ...
  void removeDataFromLocalStorage() async {
    ...
    Application.localStorageService!.categoryName = null;
    Application.localStorageService!.folderId = null;
    Application.localStorageService!.folderName = null;
