  ...
  'themeData': ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        backgroundColor: MaterialStateProperty.all(LightAppColors.appBlueColor),
      ),
    ),
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: ButtonStyle(
        ...
        side: MaterialStateProperty.all(
            BorderSide(color: LightAppColors.greyColor)),
        shape: MaterialStateProperty.all<RoundedRectangleBorder>(
          RoundedRectangleBorder(
            side: BorderSide(color: LightAppColors.blackColor, width: 0.1),
            borderRadius: BorderRadius.circular(18.0),
          ),
        ),
...
abstract class LightAppColors {
  static const pinkColor = Color(0xfffa2ffb);
  static const primary = Color(0xFFFB475F);
  static const secondary = Color(0xFFF5E1CB);
